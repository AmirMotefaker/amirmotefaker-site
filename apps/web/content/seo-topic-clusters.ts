...
export const productTopicClusters: Record<string, { fa: string[]; en: string[] }> = {
  ...
  tasvin: { fa: ["فین‌تک ایران", "تسویه مالی", "تسویه کسب‌وکار", "پرداخت و تسویه", "تسویه تأمین‌کننده"], en: ["FinTech Iran", "financial settlement", "business settlement", "payments and settlement", "supplier payouts"] },
